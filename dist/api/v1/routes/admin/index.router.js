...
const adminRoutes = (app) => {
    ...
    app.use(prefixAdmin + "/dashboard", dashboard_router_1.dashboardRoutes);
    app.use(prefixAdmin + "/topics", topic_router_1.topicRoutes);
    app.use(prefixAdmin + "/songs", song_router_1.songRoutes);
    app.use(prefixAdmin + "/uploads", upload_router_1.uploadRoutes);
};
