...
router.patch("/like/:typeLike/:songId", authMiddleware.authRequest, controller.like);
router.patch("/favorite/:typeFavorite/:songId", authMiddleware.authRequest, controller.favorite);
