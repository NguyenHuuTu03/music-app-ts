...
const index_router_1 = __importDefault(require("./api/v1/routes/client/index.router"));
const body_parser_1 = __importDefault(require("body-parser"));
const cookie_parser_1 = __importDefault(require("cookie-parser"));
const index_router_2 = __importDefault(require("./api/v1/routes/admin/index.router"));
